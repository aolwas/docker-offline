...
target/docker-$(DOCKER_VERSION)-centos7.tar.gz: target/centos7.1
...
target/docker-$(DOCKER_VERSION)-all.tar.gz: target/ubuntu14.04 target/centos7 target/centos7.1
